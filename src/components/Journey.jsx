...
const Journey = () => {
    return (
        <section className="grid md:grid-cols-2 gap-4 px-4 sm:px-8 py-8 mt-12">
            <div className="flex flex-col">
                ...
                <button className="self-center sm:self-start font-semibold bg-[#39DB4A] text-white px-6 py-3 rounded-full">Explore</button>
            </div>

            <div className=" grid grid-cols-2 lg:gap-8 gap-4 flex-wrap">

                <div className="flex flex-col items-center justify-center p-4 gap-2 border-2 rounded-2xl shadow-lg ">
                ...
                <div className="flex flex-col items-center justify-center p-4 gap-2 border-2 rounded-2xl shadow-lg ">
                    ...
                    <p className="text-[#5FE26C] font-bold text-center">Online Ordering</p>
