...
const Login = () => {
    return (
        <div className="flex h-[90vh] md:h-screen items-center justify-center">
            ...
            <form className="flex flex-col gap-4 items-center justify-center border-2 w-4/5 h-[60%] md:w-2/5 md:h-2/5 rounded-lg md:ml-[18rem] shadow-lg">
