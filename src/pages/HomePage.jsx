...
const HomePage = () => {
    return (
        <>
            <div className="grid grid-cols-2 py-6 bg-gradient-to-r from-[#fff3de] to-[#fff8ee] relative">
                ...
                <div className="relative z-0">
                    <img src={meal} alt="jeera rice" className="w-4/5 h-4/5 pt-6" />
                ...
                <img src={leave3} alt="leaves" className="absolute z-20 leave3" />
            </div>
            <PopularMeal />
            <SpecialDishes />
            <Journey />
